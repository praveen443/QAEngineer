...
//
//public class TC15_Edit_ExistingGiftWrapping extends Actions.Application
//{  
...
//	{	
//		Reporter.log("<---------- Started the TestCase : TC15_Edit_ExistingGiftWrapping ---------->");
//		System.out.println("<---------- Started the TestCase : TC15_Edit_ExistingGiftWrapping ---------->");
...
//	  
//	@Test
//	public void Edit_ExistingGiftWrappingDesignName() 
//	{				
...
//	     
//		//Calling this method to edit the existing gift wrapping design name
//	    Application.edit_ExistingGiftWrapping(driver);
//		     
...
//		Reporter.log("<-------- Ended the TestCase: TC15_Edit_ExistingGiftWrapping -------->");
//	}
//    
// } 	 
//
