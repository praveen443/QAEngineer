...
public class TC35_ValidateCustomerAddressAttributeResetFilter {
	...
	{	
   Reporter.log("<--- Started the TestCase : TC35_ValidateCustomerAddressAttributeResetFilter --->");
	   System.out.println("<--- Started the TestCase : TC35_ValidateCustomerAddressAttributeResetFilter --->");
	...
	@Test
	public void ValidateCustomerAddressAttributeResetFilter() throws InterruptedException 
	{	
   ...
   Magento_ReusableFunctions.Verify_UserLogin(driver);
	   ...
	   //Calling method to validate the 'Customer address attribute reset filter'
	   Application.validateTheCustomerAddressAttributeResetFilter(driver);
	...
	public void CloseTheBrowser(ITestResult result) throws Exception 
	{
	   ...
	   Reporter.log("<--- Ended the TestCase: TC35_ValidateCustomerAddressAttributeResetFilter --->");
	}	
