...
public class TC13_ChangetheStatusOf_GiftWrapping extends Actions.Application{
   ...
   {		
	  Reporter.log("<------- Started the TestCase: TC13_ChangetheStatusOf_GiftWrapping -------> ");
	  System.out.println("<------- Started the TestCase: TC13_ChangetheStatusOf_GiftWrapping -------> ");
   ...
   @Test
   public void ChangeStatusOfgiftWrapping() 
   {	  
	  ...
	  //Calling this method to change the status of Gift Wrapping
	  Application.changetheStatusOfGiftWrapping(driver);
   ...
   public void CloseTheBrowser(ITestResult result) throws Exception 
   {
	   ...
	   Reporter.log("<-------- Ended the TestCase: TC13_ChangetheStatusOf_GiftWrapping -------->"); 
   }
