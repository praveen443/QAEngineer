...
//   {
//	   Reporter.log("<---- Started the TestCase : TC27_SearchCustomer_basedOn_CustomerName ---->");
//	   System.out.println("<---- Started the TestCase : TC27_SearchCustomer_basedOn_CustomerName ---->");
...
//  
//   @Test
//   public void SearchCustomerBasedOnCustomerName() throws InterruptedException 
//   {
...
//	   
//	   //Calling method to Search the Customer with the given name.
//	   Application.searchCustomerbasedOnCustomerName(driver);
//	     
...
// 	  Reporter.log("<-------- Ended the TestCase: TC27_SearchCustomer_basedOn_CustomerName -------->");	  
//   }
//    
// }
